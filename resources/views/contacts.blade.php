                ...
                <div class="header">
                    ...
                    <div class="main_inbasket">
                        <p class="main_inbasket_text">
                            <span class="basket_sum"></span> рублей
                            <br>
                        ...
                        <div class="contacts_text ">
                            <p class="contacts_content_unit">
                                <span>МЫ ЭТО - ДОСТАВКА ШАШЛЫКА И УСЛУГИ ПОВАРА - ШАШЛЫЧНИКА!!!<br>
                                    ...
                                    занимается доставкой свежеприготовленного на мангале, на углях - вкусного
                                    шашлыка.<br>
                            ...
                            <form class="order-form contact-form" id="call_form">
                                <input required class="contact_form_input" type="text" placeholder="Ваше имя"
                                    name="buyer_name">
                                <input required class="contact_form_input" type="text" placeholder="Ваш телефон"
                                    name="buyer_tel" id="tel">
                                <input class="contact_form_input contact_form_button" type="submit"
