        ...
        <div class="navigation">
            <div class="wrapper">
                <nav class="navigation_ul">
                    <span>-</span>
                    <a class="navigation_item" href="index.php#shashlyk">Шашлыки</a>
                    <span>-</span>
                    <a class="navigation_item" href="index.php#post_menu">Постное меню</a>
                    <span>-</span>
                    <a class="navigation_item" href="index.php#salat">Салаты</a>
                    <span>-</span>
                    <a class="navigation_item" href="index.php#sous_lavash">Соусы и лаваши</a>
                    <span>-</span>
                    <a class="navigation_item" href="catering.php#catering">Кейтеринг</a>
                    <span>-</span>
                    <a class="navigation_item" href="index.php#big_company">Для большой компании</a>
                    <span>-</span>
                    <a class="navigation_item" href="index.php#tasty">Что-то вкусненькое</a>
                    <span>-</span>
                    <a class="navigation_item" href="contacts.php#contacts">Контакты</a>
                    <span>-</span>
                    <a class="navigation_item" href="akcii.php#akcii">Акции</a>
                    <span>-</span>
                </nav>
            </div>
        </div>
